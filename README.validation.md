...
```
     76 UPOS _ UposTag=X|_
      1 UPOS Vmn UposTag=SYM|_
     12 UPOS Y UposTag=ADJ|_
     36 UPOS Y UposTag=ADV|_
    149 UPOS Y UposTag=NOUN|_
     21 UPOS Y UposTag=PART|_
     12 UPOS Y UposTag=PROPN|_
```
